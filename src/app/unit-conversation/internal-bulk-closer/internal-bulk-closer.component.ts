...
@Component({
  selector: 'app-internal-bulk-closer',
  templateUrl: './internal-bulk-closer.component.html',
  styleUrls: ['./internal-bulk-closer.component.scss']
})
export class InternalBulkCloserComponent implements OnInit {
