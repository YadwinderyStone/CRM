...
import { TeamWiseInteractionsDataSource } from './team-interactions.datasource';
import * as XLSX from 'xlsx';
import { DatePipe } from '@angular/common';
@Component({
  selector: 'app-team-interactions-list',
  templateUrl: './team-interactions-list.component.html',
  styleUrls: ['./team-interactions-list.component.scss']
})
export class TeamInteractionsListComponent extends BaseComponent implements OnInit {  
    ...
    dataSource: TeamWiseInteractionsDataSource;
    ...
    constructor(
      ...
      this.myTeamId = userData.teamId;

      this.inventoryResource.teamId = this.myTeamId;
    }
  
    ngOnInit(): void {
      this.dataSource = new TeamWiseInteractionsDataSource(this.inventoryService);
    ...
    dowanloadList(){
      this.setParams();
      this.inventoryService.getTeamWiseInteractionsList(this.inventoryResource).subscribe((res:any)=>{
        ...
        XLSX.utils.book_append_sheet(workBook, workSheet, 'Team Interaction Report');
        XLSX.writeFile(workBook, 'Team Interaction Report' + ".xlsx");  
      })
