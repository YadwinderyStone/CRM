...
export class InventoryListComponent extends BaseComponent implements OnInit {
  ...
  displayedColumns: string[] = ['action','interactionid', 'createdat', 'interactiontype', 'status', 'substatus', 'messages', 'contant', 'emailId','phone','createdteam', 'assignto', 'reopen', 'category', 'subcatagory', 'gstn', 'problemreported1', 'docketno'];
