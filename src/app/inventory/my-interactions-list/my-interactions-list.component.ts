...
@Component({
  ...
  styleUrls: ['./my-interactions-list.component.scss']
})
export class MyInteractionsListComponent extends BaseComponent implements OnInit {
  ...
  dataSource: MyInteractionsDataSource;
  ...
  ngOnInit(): void {
    this.dataSource = new MyInteractionsDataSource(this.inventoryService);
