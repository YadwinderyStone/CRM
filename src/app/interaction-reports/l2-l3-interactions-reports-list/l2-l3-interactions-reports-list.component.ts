...
@Component({
  selector: 'app-l2-l3-interactions-reports-list',
  templateUrl: './l2-l3-interactions-reports-list.component.html',
  styleUrls: ['./l2-l3-interactions-reports-list.component.scss']
})
export class L2L3InteractionsReportsListComponent extends BaseComponent implements OnInit {
  toDate: any = new Date();
  ...
  ngOnInit(): void {
    ...
    this.dataSource.loadL2L3Data(this.inventoryResource);
  ...
  dowanloadExcal(){
    let url = `Excel/GetExcelnteractionDataL2L3Report`
    this.isLoading = true;
    this.setParams();
