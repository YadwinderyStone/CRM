...
export class AgentProductivityComponent extends BaseComponent implements OnInit {
  toDate: any = new Date();
  ...
  ngOnInit(): void {
    ...
    this.dataSource.loadAgentReportData(this.inventoryResource);
  ...
  dowanloadExcal() {
    ...
    this.interactionReportsService.get187InteractionsReportsExcelDowanload(url, this.inventoryResource).subscribe((res: any) => {
      ...
      a.href = url;
      a.download = 'agentProductivityReports.xlsx';
