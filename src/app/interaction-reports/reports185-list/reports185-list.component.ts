...
@Component({
  selector: 'app-reports185-list',
  templateUrl: './reports185-list.component.html',
  styleUrls: ['./reports185-list.component.scss']
})
export class Reports185ListComponent extends BaseComponent implements OnInit {
  toDate: any = new Date();
  fromDate: any = new Date();
  currentDate = new Date();
  isLoading: boolean = false;
  dataSource: InteractionDataSource;
  displayedColumns: string[] = ['interactionid', 'interactiontype', 'status', 'substatus', 'category', 'subcatagory', 'contant', 'mobile', 'createdteam', 'createdat', 'assignto', 'problemId', 'gstn', 'problemreported1', 'docketno'];
  ...
  ngOnInit(): void {
    ...
    this.dataSource.load185Data(this.inventoryResource);
  ...
  dowanloadList() {
    this.isLoading = true;
    this.setParams();
    this.interactionReportsService.get185InteractionsReportsList(this.inventoryResource).subscribe((res: any) => {
      ...
      let heading = [[
        ...
        this.translationService.getValue('Mobile No.'),
