...
@Component({
  selector: 'app-pending-interactions-reports-list',
  templateUrl: './pending-interactions-reports-list.component.html',
  styleUrls: ['./pending-interactions-reports-list.component.scss']
})
export class PendingInteractionsReportsListComponent extends BaseComponent implements OnInit {
  toDate: any = new Date();
  ...
  ngOnInit(): void {
    ...
    this.dataSource.loadPendingData(this.inventoryResource);
