...
import { AddMembersComponent } from 'src/app/queue/add-members/add-members.component';

@Component({
  selector: 'app-escalation-list',
  templateUrl: './escalation-list.component.html',
  styleUrls: ['./escalation-list.component.scss'],
  animations: [
...
export class EscalationListComponent extends BaseComponent implements OnInit {
  queueList: Queue[] = [];
  userList: any = [];
